...
class StoryBrain {
  ...
  String getStory() => _storyData.elementAt(0).storyText;

  String getFirstChoice() => _storyData.elementAt(0).firstChoiceText;

  String getSecondChoice() => _storyData.elementAt(0).secondChoiceText;
